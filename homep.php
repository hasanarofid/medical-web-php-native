    ...
    <div class="container">
        ...
        <div class="layout-page">
          ...
          <aside id="layout-menu" class="layout-menu-horizontal menu-horizontal menu bg-menu-theme flex-grow-0" data-bg-class="bg-menu-theme" style="touch-action: none; user-select: none;">
            ...
            <img src="../assets/gambar_category/<?php echo $pecah['gambar']; ?>" width="100" class="mb-3">
            <h4 style="color: white; background-color: #fff; padding: 10px; border-radius: 5px;"><?php echo $pecah['name']; ?></h4>
        </div>
